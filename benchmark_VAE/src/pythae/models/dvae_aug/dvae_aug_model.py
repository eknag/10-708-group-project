...
class DVAEAug(VAE):
    ...
    Args:
        model_config(DVAEAugConfig): The Variational Autoencoder configuration seting the main
    ...
    def forward(self, inputs: BaseDataset, **kwargs):
        ...
        x = inputs["data"]
        noisy_x = self.apply_transform(x, self.aug_type)
