...
from .pvae_config import PVAEConfig
...
class PVAE(VAE):
    ...
    Args:
        model_config(PVAEConfig): The Variational Autoencoder configuration seting the main 
    ...
    def forward(self, inputs: BaseDataset, **kwargs):
        ...
        # project z to the sphere
        z = z / torch.norm(z, dim=1, keepdim=True) * self.radius
